...
export function BottomNav() {
  ...
  const items = [
    { href: '/dashboard', label: t('nav.home'), key: '🏠' },
    { href: '/ask', label: t('nav.ask'), key: '💬' },
    { href: '/settings', label: t('nav.settings'), key: '⚙️' },
  ]
